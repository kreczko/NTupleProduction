...
ElectronIdScaleFactorsFile = opj(
    BAT_DATA, 'ElectronCutBasedID_MediumWP_76X_SF2D.root')
ElectronIsoScaleFactorsFile = opj(BAT_DATA, 'Elec_SF_Fit_Syst.root')
ElectronTriggerScaleFactorsFile = opj(
    BAT_DATA, 'ElectronTriggerEfficiencies.root')
MuonIdScaleFactorsFile = opj(BAT_DATA, 'MuonID_Z_RunCD_Reco76X_Feb15.root')
MuonIsoScaleFactorsFile = opj(BAT_DATA, 'MuonIso_Z_RunCD_Reco76X_Feb15.root')
MuonTriggerScaleFactorsFile = opj(
    BAT_DATA, 'SingleMuonTrigger_Z_RunCD_Reco76X_Feb15.root')
